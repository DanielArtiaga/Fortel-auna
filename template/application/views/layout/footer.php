     ...
     <footer class="footer">
         <div class="container-fluid">
             <div class="row">
                 <div class="col-md-6">
                     <div><strong class="font-w400">Fortel Experience Portal FEX</strong> © <script>
                             document.write(new Date().getFullYear())
                         </script> All Rights Reserved </div>
                 </div>
                 <div class="col-md-6">
                     <div class="d-none d-md-flex gap-4 align-item-center justify-content-md-end footer-links">
                         <a href="../metadata/haml/version1.0" target="_blank">Made with <i style="color: red;" class="fa fa-heart"></i> by desarrollo@fortelcorp.com</a>
                     </div>
                 </div>
             </div>
         </div>
     ...
     <!-- Mirrored from coderthemes.com/ubold/layouts/creative/layouts-detached.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Dec 2022 18:27:40 GMT -->
